...
[here](https://s3.amazonaws.com/udacity-dsand/testdir.zip):
...
Note: `os.walk()` is a handy Python method which can achieve this task very
easily. However, for this problem you are not allowed to use `os.walk()`.
